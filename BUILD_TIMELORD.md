...
required to run a [Timelord](https://github.com/Thyme-Network/thyme-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Thyme-Network/thyme-blockchain/blob/main/install-timelord.sh)

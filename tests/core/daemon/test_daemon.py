...
from thyme.server.server import ssl_context_for_server
from thyme.types.peer_info import PeerInfo
from thyme.util.block_tools import BlockTools
from thyme.util.ints import uint16
from thyme.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, simulation, get_daemon):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "thyme_full_node")
        await ws.send_str(payload)

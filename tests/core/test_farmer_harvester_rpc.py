...
from thyme.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from thyme.protocols import farmer_protocol
from thyme.rpc.farmer_rpc_api import FarmerRpcApi
from thyme.rpc.farmer_rpc_client import FarmerRpcClient
from thyme.rpc.harvester_rpc_api import HarvesterRpcApi
from thyme.rpc.harvester_rpc_client import HarvesterRpcClient
from thyme.rpc.rpc_server import start_rpc_server
from thyme.types.blockchain_format.sized_bytes import bytes32
from thyme.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from thyme.util.block_tools import get_plot_dir
...
from thyme.wallet.derive_keys import master_sk_to_wallet_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xth"), encode_puzzle_hash(new_ph_2, "xth"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xth"))
            ...
            assert config["farmer"]["xth_target_address"] == encode_puzzle_hash(new_ph, "xth")
            assert config["pool"]["xth_target_address"] == encode_puzzle_hash(new_ph_3, "xth")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xth")

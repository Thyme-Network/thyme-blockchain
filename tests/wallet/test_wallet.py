...
from thyme.protocols.full_node_protocol import RespondBlock
from thyme.server.server import ThymeServer
from thyme.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
...
class TestWalletSimulator:
    ...
    #         outbound: List[WSThymeConnection] = wallet.server.get_outgoing_connections()

...
from thyme.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "thyme/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "thyme/wallet/puzzles/cc.clvm",
        "thyme/wallet/puzzles/thymelisp_deserialisation.clvm",
        "thyme/wallet/puzzles/rom_bootstrap_generator.clvm",
        "thyme/wallet/puzzles/generator_for_single_coin.clvm",
        "thyme/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "thyme/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "thyme/wallet/puzzles/lock.inner.puzzle.clvm",
        "thyme/wallet/puzzles/p2_conditions.clvm",
        "thyme/wallet/puzzles/p2_delegated_conditions.clvm",
        "thyme/wallet/puzzles/p2_delegated_puzzle.clvm",
        "thyme/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "thyme/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "thyme/wallet/puzzles/p2_puzzle_hash.clvm",
        "thyme/wallet/puzzles/rl_aggregation.clvm",
        "thyme/wallet/puzzles/rl.clvm",
        "thyme/wallet/puzzles/sha256tree_module.clvm",
        "thyme/wallet/puzzles/singleton_top_layer.clvm",
        "thyme/wallet/puzzles/did_innerpuz.clvm",
        "thyme/wallet/puzzles/decompress_puzzle.clvm",
        "thyme/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "thyme/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "thyme/wallet/puzzles/block_program_zero.clvm",
        "thyme/wallet/puzzles/test_generator_deserialize.clvm",
        "thyme/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
    ]
)

clvm_include_files = set(
    ["thyme/wallet/puzzles/create-lock-puzzlehash.clvm", "thyme/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "thyme/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to thyme/wallet/puzzles, but not added to `wallet_program_files`
        """

...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Thyme Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/Thyme-Network/thyme-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
echo ""
echo "Thyme blockchain install.sh complete."
echo "For assistance join us on Discord in the #testnet chat channel:"
echo "https://discord.gg/TgJyxsEFFc"
echo ""
echo "Try the Quick Start Guide to running thyme-blockchain:"
echo "https://github.com/Thyme-Network/thyme-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'thyme init' to begin."

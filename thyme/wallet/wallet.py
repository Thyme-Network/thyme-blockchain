...
from thyme.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from thyme.full_node.bundle_tools import simple_solution_generator
...
from thyme.types.announcement import Announcement
...
from thyme.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from thyme.wallet.puzzles.puzzle_utils import (
...
from thyme.wallet.secret_key_store import SecretKeyStore
from thyme.wallet.sign_coin_solutions import sign_coin_solutions
...
from thyme.wallet.wallet_info import WalletInfo
...
class Wallet:
    ...
    async def create_spend_bundle_relative_thyme(self, thyme_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if thyme_amount < 0:
            utxos = await self.select_coins(abs(thyme_amount), exclude)
        else:
        ...
        thyme_amount = spend_value + thyme_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": thyme_amount}]

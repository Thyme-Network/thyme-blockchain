...
from thyme.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "thyme" in cc_discrepancies:
                    cc_discrepancies["thyme"] = cc_discrepancies["thyme"] + diff
                else:
                    cc_discrepancies["thyme"] = diff

...
from thyme.util.misc import format_minutes
...
async def summary(rpc_port: int, wallet_rpc_port: int, harvester_rpc_port: int, farmer_rpc_port: int) -> None:
    ...
    if amounts is not None:
        print(f"Total thyme farmed: {amounts['farmed_amount'] / units['thyme']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['thyme']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['thyme']}")
        print(f"Last height farmed: {amounts['last_height_farmed']}")
    else:
        print("Total thyme farmed: Unknown")
    ...
    print("Note: log into your key using 'thyme wallet show' to see rewards for each key")

...
from thyme.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56888"
            testnet_introducer = "beta1_introducer.thymenetwork.org"
            testnet = "testnet7"
            ...
            mainnet_port = "16988"
            mainnet_introducer = "introducer.thymenetwork.org"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running thyme services for changes to take effect")

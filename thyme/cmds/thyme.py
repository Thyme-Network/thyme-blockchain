...
from thyme.cmds.configure import configure_cmd
from thyme.cmds.farm import farm_cmd
from thyme.cmds.init import init_cmd
from thyme.cmds.keys import keys_cmd
from thyme.cmds.netspace import netspace_cmd
from thyme.cmds.plots import plots_cmd
from thyme.cmds.show import show_cmd
from thyme.cmds.start import start_cmd
from thyme.cmds.stop import stop_cmd
from thyme.cmds.wallet import wallet_cmd
...
@click.group(
    help=f"\n  Manage thyme blockchain infrastructure ({__version__})\n",
    epilog="Try 'thyme start node', 'thyme netspace -d 192', or 'thyme show -s'",
...
@cli.command("version", short_help="Show thyme version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs thyme daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from thyme.daemon.server import async_run_daemon
    import asyncio

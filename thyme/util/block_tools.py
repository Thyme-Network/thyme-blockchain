...
from thyme.cmds.init_funcs import create_all_ssl, create_default_thyme_config
from thyme.full_node.bundle_tools import (
    best_solution_generator_from_template,
    detect_potential_template_generator,
    simple_solution_generator,
)
from thyme.plotting.create_plots import create_plots
from thyme.consensus.block_creation import create_unfinished_block, unfinished_block_to_full_block
from thyme.consensus.block_record import BlockRecord
from thyme.consensus.blockchain_interface import BlockchainInterface
from thyme.consensus.coinbase import create_puzzlehash_for_pk
from thyme.consensus.constants import ConsensusConstants
from thyme.consensus.default_constants import DEFAULT_CONSTANTS
from thyme.consensus.deficit import calculate_deficit
from thyme.consensus.full_block_to_block_record import block_to_block_record
from thyme.consensus.make_sub_epoch_summary import next_sub_epoch_summary
from thyme.consensus.pot_iterations import (
    calculate_ip_iters,
...
from thyme.consensus.vdf_info_computation import get_signage_point_vdf_info
from thyme.full_node.signage_point import SignagePoint
from thyme.plotting.plot_tools import PlotInfo, load_plots, parse_plot_info
...
from thyme.types.blockchain_format.proof_of_space import ProofOfSpace
...
from thyme.types.generator_types import BlockGenerator, CompressorArg
...
from thyme.util.config import load_config, save_config
from thyme.util.hash import std_hash
from thyme.util.ints import uint8, uint32, uint64, uint128
from thyme.util.keychain import Keychain, bytes_to_mnemonic
from thyme.util.path import mkdir
from thyme.util.vdf_prover import get_vdf_info_and_proof
from thyme.util.wallet_tools import WalletTool
from thyme.wallet.derive_keys import (
...
class BlockTools:
    ...
    def __init__(
        ...
        if len(self.pool_pubkeys) == 0 or len(farmer_pubkeys) == 0:
            raise RuntimeError("Keys not generated. Run `thyme generate keys`")
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "xth")
...
def get_plot_dir() -> Path:
    cache_path = Path(os.path.expanduser(os.getenv("THYME_ROOT", "~/.thyme/"))) / "test-plots"
    mkdir(cache_path)
    return cache_path

...
from thyme.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from thyme.harvester.harvester import Harvester
from thyme.plotting.plot_tools import PlotInfo, parse_plot_info
from thyme.protocols import harvester_protocol
from thyme.protocols.farmer_protocol import FarmingInfo
from thyme.protocols.protocol_message_types import ProtocolMessageTypes
from thyme.server.outbound_message import make_msg
...
from thyme.util.api_decorators import api_request, peer_required
from thyme.util.ints import uint8, uint32, uint64
from thyme.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSThymeConnection
    ):
        """
